...
public final class PhantomFluidSlotWidget extends Widget implements PickTarget {
    private final SlotData data;
    private MachineLayoutWidget dragOwner;
    private RecipeIngredientRole role;

    public PhantomFluidSlotWidget(SlotData data, int x, int y) {
        super(x, y, 18, 18);
        this.data = data;
    }
    ...
    public void drawInBackground(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (role != null) {
            int color = role == RecipeIngredientRole.INPUT ? UiColors.FLUID_INPUT_TINT : UiColors.FLUID_OUTPUT_TINT;
