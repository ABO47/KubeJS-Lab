...
public final class SearchDropdownWidget extends WidgetGroup implements PopupProvider {
    ...
    public SearchDropdownWidget(int x, int y, int w, int h) {
        super(x, y, w, h);
        field = new TextField(0, 0, w, h, null, text -> {
        });
    ...
    public void drawInForeground(@Nonnull GuiGraphics g, int mx, int my, float pt) {
        ...
        for (int row = 0; row < visibleRows; row++) {
            ...
            TextTexture tex = new TextTexture(option, UiColors.TEXT_PRIMARY)
                    .setWidth(w - 8)
