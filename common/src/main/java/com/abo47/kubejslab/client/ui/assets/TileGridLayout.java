...
public record TileGridLayout(
    ...
    public static TileGridLayout calculate(
        ...
        int contentW = Math.max(safeTileW, width - safePadX * 2 - (showScroll ? LabScrollBarWidget.RESERVED_WIDTH : 0));
        ...
        int safeStart = LabScrollMath.clamp(scrollStart, maxStart);
    ...
    public int scrollBarX() {
        return width - LabScrollBarWidget.RESERVED_WIDTH - 1;
    }
