...
public record RecipeFieldValues(boolean shapeless, float experience, int cookingTime, int count,
    ...
    public RecipeFieldValues(boolean shapeless, float experience, int cookingTime, int count,
            int processingTime, HeatRequirement heatRequirement, boolean keepHeldItem, boolean acceptMirrored,
    ...
    public static RecipeFieldValues defaults() {
        return new RecipeFieldValues(false, 0f, 200, 1, 100, HeatRequirement.NONE, false, true, 3, 3, 0, 0,
                "", "", "generic", "", 0, 0);
    }
}
