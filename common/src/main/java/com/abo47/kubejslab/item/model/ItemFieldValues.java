...
public record ItemFieldValues(String displayName, String texture, String rarity, int maxStack, int maxDamage,
    ...
    public static ItemFieldValues defaults() {
        return new ItemFieldValues("", "", "", 64, 0, 0, false, false, "", "", "", 0, 0f, false, false,
                false, "", 0, 0, 0f, "", 0f, 0f, 0f, "", 0, 0f, 0f, 0, 0f, 0f, 0, 0, "", 0f, "", "", 0f, 0f,
                "", "", 0f, "", "", 0);
    }

    public static void write(FriendlyByteBuf buf, ItemFieldValues v) {
    ...
    public static ItemFieldValues read(FriendlyByteBuf buf) {
        return new ItemFieldValues(buf.readUtf(), buf.readUtf(), buf.readUtf(),
